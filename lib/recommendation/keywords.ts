 ...
 * - MockGeminiProvider(외부 AI 없이 동작하는 분석기)의 키워드·대화 해석
 * - Gemini 결과와 섞는 규칙 기반 보조 vector
 * 에서 공통으로 사용합니다.
 *
...
export const KEYWORD_RULES: Rule[] = [
  ...
  { words: ["맛집", "먹방", "음식", "먹거리", "미식", "노포", "시장음식", "시장 음식", "먹자골목", "길거리음식"], weights: { food: 1, local: 0.55, travel: 0.35, discovery: 0.2 } },
